  ...
  try {
    ...
    <html>
        <body>
            <p>
                Dear ${userName}, 
                Congratulations! You are now a verified member of our Community. Thank you for being part of the  community.
                <br />
                You can get all study materials & including question, notices in our community website. You can also better learn about your classmates, seniors & juniors as well there.
                <br />
                Happy coding :)
  ...
  try {
    ...
    <html>
        <body>
            <p>
                Dear Admin, 
                Someone with following details has been newly registered to community.
            </p>
            <br />
            <p>
              Name : ${name} <br/>
